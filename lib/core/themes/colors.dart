...
abstract final class AppColors {
  ...
  //colors from compass app from flutter docs
  ...
  static ColorScheme lightColorScheme(BuildContext context) =>
  ...
  static ColorScheme darkColorScheme(BuildContext context) =>
      Theme.of(context).colorScheme.copyWith(
